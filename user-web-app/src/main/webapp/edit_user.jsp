...
<html>
    ...
    <body>
        <div class="p-3 mb-2 text-white">           
            <h2 style="text-align: center; padding: 30px;">Edit Account</h2>
            <form:form method="POST" action="/edit-user" modelAttribute="user">
                <table class="form">
                    <tr>
                        <td><form:label path="id">Id </form:label></td>
                        <td style=" padding-bottom: 10px"><form:input path="id" required="true"/></td>                        
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td style="padding-top: 10px"><input type="submit" value="Edit Account"/></td>
                    </tr>
                </table>
            </form:form>
        </div>        
