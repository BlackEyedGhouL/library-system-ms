...
<html>
    ...
    <body>
        <div class="p-3 mb-2 text-white">
            <div>            
                <h2 style="text-align: center; padding: 30px;">Search Books by Name</h2>
                <form:form method="POST" action="/search-books-name" modelAttribute="book">
                    <table>                    
                        <tr>
                            <td><form:label path="book_name">Book Name</form:label></td>
                            <td><form:input path="book_name" required="true"/></td>
                        </tr>                 
                        <tr>
